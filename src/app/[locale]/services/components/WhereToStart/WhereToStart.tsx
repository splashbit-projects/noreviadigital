...
export const WhereToStart = () => {
  const items = [
    { title: 'Discover pre-built packages designed to solve real business challenges.', url: '/' },
    { title: 'Discover pre-built packages designed to solve real business challenges.', url: '/' },
  ];
    ...
    <div className="_container">
      <section className={st.whereToStart}>
        <section className={st.heading}>
          ...
          <p>
            We get it — choosing the right service isn’t always obvious. That’s why we offer two
